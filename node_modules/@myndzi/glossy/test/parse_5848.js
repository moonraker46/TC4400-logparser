var bufferFrom = require('../lib/glossy/buffer_from');
...
assert.deepEqual(syslogParser.parseSignedCertificate(fullySignedSD['ssign-cert']), {
    ...
    keyBlob: bufferFrom(fullySignedSD['ssign-cert']['FRAG'].split(/\s/)[2], encoding='base64'),
    thisSignature:  bufferFrom(fullySignedSD['ssign-cert']['SIGN'], encoding='base64')
});
